    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{route('detailsCategory',$category->slug)}}">{{$category->name}}</a>
                </li>
                <li>
            ...
            <div class="flex-1">
                ...
                <div class="slider">
                    <div class="thumbnail">
                        ...
                        <div class="px-2">
                            <div class="item selected" data-img="{{$row->url}}">
                                <img src="{{$row->url}}" alt="front1"
                ...
                <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white">
                        <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                            <img src="{{$r->galleries->first()->url}}" alt=""
                                class="w-full h-full object-cover object-center" />
                        </div>
                        <h5 class="text-lg font-semibold mt-4">{{$r->name}}</h5>
                        <span class="">IDR {{number_format($r->price)}}</span>
                        <a href="{{route('detailsProduct',$r->slug)}}" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
