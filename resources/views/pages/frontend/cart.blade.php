 ...
 <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
    <div class="px-4 flex-none">
        <div class="" style="width: 90px; height: 90px">
            <img src="{{$row->product->galleries->first()->url}}" alt="chair-1"
    ...
    <div class="px-4 w-auto flex-1 md:w-5/12">
        <div class="">
            ...
            <span class="text-sm md:text-lg">{{$row->product->name}}</span>
    ...
    <div class="px-4 w-2/12">
        <div class="text-center">
            <form action="{{route('cart-Delete', $row->id)}}" method="POST">
                ...
                @method('DELETE')
                <button type="submit"
                data-delete-item="1" class="text-red-600 border-none focus:outline-none px-3 py-1">
                    X
                </button>
            </form>
