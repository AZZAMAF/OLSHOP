                ...
                @foreach ($product as $nam)
                    ...
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{$nam->galleries->first()->url}}" alt=""
                                class="w-full h-full object-cover object-center" />
                        </div>
                        <h5 class="text-lg font-semibold mt-4">{{$nam->name}}</h5>
                        <span class="">IDR {{$nam->price}}</span>
                        <a href="{{route('detailsProduct', $nam->slug)}}" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
